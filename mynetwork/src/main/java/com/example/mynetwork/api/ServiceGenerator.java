...
public class ServiceGenerator {
  ...
  private static Retrofit.Builder builder(String BASE_URL) {
    if (BASE_URL.contains("http://studio.casadigi.com/casadigihomeserver/Info")) {
  ...
  public static <S> S createService(Class<S> serviceClass, final HeaderInfo headerInfo) {
          ...
          public okhttp3.Response intercept(Chain chain) throws IOException {
            ...
            if (original.url().toString().contains("favourite")) {
              ...
              requestBuilder = original.newBuilder()
                ...
                .contains("http://studio.casadigi.com/casadigihomeserver/Info")) {
              requestBuilder = original.newBuilder()
                  .method(original.method(), original.body());
            } else {
              // Request customization: add request headers
    ...
    if (headerInfo.getBaseUrl().contains("http://studio.casadigi.com/casadigihomeserver/Info")) {
      BASE_URL = headerInfo.getBaseUrl();
    }
